...
use really4you\E\Sign\Helper\response\EsignResponse;
...
//        }
        ...
        if (Esign::getENABLEHTTPPROXY()) {
            curl_setopt($ch, CURLOPT_PROXYAUTH, CURLAUTH_BASIC);
            curl_setopt($ch, CURLOPT_PROXY, Esign::getHTTPPROXYIP());
            curl_setopt($ch, CURLOPT_PROXYPORT, Esign::getHTTPPROXYPORT());
